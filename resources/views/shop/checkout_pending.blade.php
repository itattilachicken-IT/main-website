    ...
    <div class="card shadow-lg border-warning">
        <div class="card-body text-center p-5">
            ...
            <div class="mb-3">
                ...
                <!-- Test STK Push -->
                <a href="{{ route('checkout.test_mpesa', $order->id) }}" class="btn btn-info mb-2">
                    Test STK Push
                </a>

                <!-- Simulate Success -->
                <a href="{{ route('checkout.simulate_mpesa_success', $order->id) }}" class="btn btn-success mb-2">
                    Simulate Success
                </a>

                <!-- Simulate Fail -->
                <a href="{{ route('checkout.simulate_mpesa_fail', $order->id) }}" class="btn btn-danger mb-2">
                    Simulate Fail
                </a>
            </div>
